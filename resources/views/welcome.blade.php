      ...
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img src="assets/img/gallery/logo.png" height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            </div><a class="btn btn-primary order-1 order-lg-0 ms-lg-3" href="#!">Hubungi Kami</a>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-8">
              <h1 class="fw-normal fs-6 fs-xxl-7">Penyedia layanan kurir </h1>
              <h1 class="fw-bolder fs-6 fs-xxl-7 mb-2">yang terpercaya.</h1>
              <p class="fs-1 mb-5">Kami mengantarkan produk Anda dengan aman <br />ke rumah Anda dalam waktu yang tepat. </p><a class="btn btn-primary me-2" href="#!" role="button">Mulai Sekarang<i class="fas fa-arrow-right ms-2"></i></a>
            </div>
          </div>
        </div>
      </section>
              ...
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5"><img class="img-fluid" src="assets/img/icons/services-1.svg" alt="..." />
                    <h5 class="my-4">Layanan Bisnis</h5>
                  </div>
                  <p>Menyediakan layanan pengiriman ke seluruh kota, dengan estimasi barang sampai di alamat Anda dalam 48–72 jam.</p>
                  <ul class="list-unstyled">
                    <li class="mb-2"><span class="me-2"><i class="fas fa-circle text-primary" style="font-size:.5rem"></i></span>Barang Perusahaan
                    </li>
                    <li class="mb-2"><span class="me-2"><i class="fas fa-circle text-primary" style="font-size:.5rem"></i></span>Pengiriman
                    </li>
                    <li class="mb-2"><span class="me-2"><i class="fas fa-circle text-primary" style="font-size:.5rem"></i></span>Aksesori
                    </li>
                  </ul>
                  <div class="text-center my-5">
                    <div class="d-grid">
                      <button class="btn btn-outline-danger" type="submit">Selengkapnya </button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5"><img class="img-fluid" src="assets/img/icons/services-2.svg" alt="..." />
                    <h5 class="my-4">Layanan Antar Wilayah</h5>
                  </div>
                  <p>Menyediakan layanan pengiriman ke berbagai wilayah dengan estimasi sampai 48–72 jam.</p>
                  <ul class="list-unstyled">
                    <li class="mb-2"><span class="me-2"><i class="fas fa-circle text-primary" style="font-size:.5rem"></i></span>Bandwidth Tanpa Batas
                    </li>
                    <li class="mb-2"><span class="me-2"><i class="fas fa-circle text-primary" style="font-size:.5rem"></i></span>Koneksi Terenkripsi
                    </li>
                    <li class="mb-2"><span class="me-2"><i class="fas fa-circle text-primary" style="font-size:.5rem"></i></span>Log Lalu Lintas Aktif
                    </li>
                  </ul>
                  <div class="text-center my-5">
                    <div class="d-grid">
                      <button class="btn btn-danger hover-top btn-glow border-0" type="submit">Selengkapnya</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5"><img class="img-fluid" src="assets/img/icons/services-3.svg" alt="..." />
                    <h5 class="my-4">Layanan Personal</h5>
                  </div>
                  <p>Anda dapat mempercayakan pengiriman dokumen penting Anda kepada kami dengan aman dan cepat ke lokasi tujuan.</p>
                  <ul class="list-unstyled">
                    <li class="mb-2"><span class="me-2"><i class="fas fa-circle text-primary" style="font-size:.5rem"></i></span>Bandwidth Tanpa Batas
                    </li>
                    <li class="mb-2"><span class="me-2"><i class="fas fa-circle text-primary" style="font-size:.5rem"></i></span>Koneksi Terenkripsi
            ...
            <div class="col-12">
              <div class="card bg-dark text-white py-4 py-sm-0"><img class="w-100" src="assets/img/gallery/video.png" alt="video" />
                <div class="card-img-overlay bg-dark-gradient d-flex flex-column flex-center"><img src="assets/img/icons/play.png" width="80" alt="play" />
                  <h5 class="text-primary">PENGIRIMAN TERCEPAT</h5>
                  <p class="text-center">Anda dapat menerima barang berharga Anda dalam waktu tercepat dengan aman.<br class="d-none d-sm-block" />Karena kebutuhan darurat Anda adalah<br class="d-none d-sm-block" />prioritas utama kami.</p><a class="stretched-link" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"></a>
        ...
        <div class="container-fluid">
          <div class="row flex-center">
            ...
            <div class="col-md-8 col-lg-5 text-center">
              <h5 class="text-danger">TESTIMONI</h5>
                ...
                <div class="row h-100">
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 card-span p-3">
                      <div class="card-body">
                        <h5 class="mb-0 text-primary">Pelayanan luar biasa!</h5>
                        <p class="card-text pt-3">Saya membeli sebuah ponsel dari situs e-commerce, dan penyedia layanan kurir ini membantu saya dalam proses pengirimannya ke rumah. Saya menerima ponsel saya dalam satu hari, dan saya sangat puas dengan layanan mereka ketika saya menerimanya. </p>
                        <div class="d-xl-flex justify-content-between align-items-center">
                          ...
                          <div class="d-flex align-items-center"><img class="img-fluid" src="assets/img/icons/avatar.png" alt="" />
                            <div class="flex-1 ms-3">
                              ...
                              <p class="fs--2 fw-normal mb-0">Direktur Eksekutif, DLF</p>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="row h-100">
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 card-span p-3">
                      <div class="card-body">
                        <h5 class="mb-0 text-primary">Pelayanan luar biasa!</h5>
                        <p class="card-text pt-3">Pelayanan luar biasa!</p>
                        <div class="d-xl-flex justify-content-between align-items-center">
                          <div class="d-flex align-items-center mb-3"><i class="fas fa-star text-primary me-1"></i><i class="fas fa-star text-primary me-1"></i><i class="fas fa-star text-primary me-1"></i><i class="fas fa-star text-primary me-1"></i><i class="fas fa-star text-primary me-1"></i></div>
                          <div class="d-flex align-items-center"><img class="img-fluid" src="assets/img/icons/avatar.png" alt="" />
                            <div class="flex-1 ms-3">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5 col-xl-4"><img src="assets/img/illustrations/callback.png" alt="..." />
              <h5 class="text-danger">Minta Kami Menghubungi Anda</h5>
              <h2>Kami akan menghubungi Anda secepatnya.</h2>
              <p class="text-muted">Senin hingga Jumat, 9 pagi – 5 sore.</p>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-4">
              <form class="row">
                ...
                <div class="d-grid">
                  <button class="btn btn-primary" type="submit">Kirim Pesan<i class="fas fa-paper-plane ms-2"></i></button>
                </div>
              </form>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8 col-lg-5 mb-6 text-center">
              <h5 class="text-danger">LOKASI KAMI</h5>
            ...
            <div class="col-12">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-5 d-flex flex-center">
                    <div class="card-body">
                      ...
                      <p><i class="fas fa-phone-alt text-warning me-3"></i><span class="text-700">Senin – Jumat: 10 pagi – 10 malam<br/><span class="ps-4">Minggu: 11 pagi – 9 malam  </span></span></p>
              ...
              <div class="text-center">
                <button class="btn btn-primary px-5" type="submit"><i class="fas fa-phone-alt me-2"></i><a class="text-light" href="tel:123-456789">Hubungi kami untuk pengiriman: 123–456789</a></button>
              </div>
            </div>
          </div>
        </div>
